...
logoleft_name: '![QR code for paper](images\placeholder1.jpg){.main-img-left}'    
                            #Bottom right main section image 
logoright_name: '![Do we have a lab logo? USF logo?](images\placeholder2.jpg){.main-img-right}' 
...
- Interactions between interests (**I**) and self-efficacy (**SE**), modeled by social cognitive career theory (SSCT), are used to predict domain relevent carreer paths. 
- **SE** is a precursor to **I** development, implying the two constructs are ‘related but distinct’. 

![SCCT Flowchart?](images\placeholder3.jpg)
...
![RIASEC Hexagon](images\placeholder4.jpg)
