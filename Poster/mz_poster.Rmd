...
```{r, echo=FALSE, collapse=TRUE, fig.cap= 'Social Cognitive Career Theory model ', fig.height=3.5, out.width="90%" }
...
- Previous meta-analytic results have found strong mean correlations between the two. 
- Existing heterogeneity is attributed to tangible differences between the constructs. [@rottinghausRelationSelfefficacyInterests2003]
