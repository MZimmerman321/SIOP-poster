...
```{r myprettycode, echo=FALSE,collapse=TRUE, fig.cap= 'Latent variable factor loadings for correlated trait–correlated uniqueness CFA model', fig.height=3.5, out.width="50%"}
...
χ2(75), Nharmonic = 3 903.936) = 2566.848, comparative fit index = .943, root mean square error of approximation = .092 [.089, .096], mean absolute residual correlation = .042. 
